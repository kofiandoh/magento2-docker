...
RUN yum install php56w-libmcrypt  php56w.libmcrypt.so.4()(64bit) php56w-mcrypt

RUN yum -y install php56w-pecl-memcache    php56w-fpm php56w-intl  php56w-mbstring php56w-mysql php56w-pdo php56w-mbstring php56w-soap php56w-pecl-zendopcache php56w-xml php56w-gd php56w-opcache php56w-pecl-imagick
# <---- End
